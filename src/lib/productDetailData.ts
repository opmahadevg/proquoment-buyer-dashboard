...
export const ALL_PRODUCT_DETAIL_DATA: Record<string, ProductDetailData> = {
  'prod-001': {
    ...
    files: [
      ...
      {
        id: 'file-004',
        name: 'Black-Puffed-Jacket-Supplier-Comparison.xlsx',
        date: 'Apr 20, 2026',
      },
    ],
      ...
      samples: [
        {
          id: 'smp-003',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_10a7580e1-1772222839735.png',
        ...
        },
        {
          id: 'smp-004',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_1aeaff2ca-1777719476038.png',
      ...
      references: [
        {
          id: 'ref-002',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_134c59208-1777719475319.png',
        ...
        },
        {
          id: 'ref-003',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_14def5fc7-1777719478936.png',
      ...
      samples: [
        {
          id: 'smp-005',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_18f8ae602-1777719476000.png',
        ...
        },
        {
          id: 'smp-006',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_13e7a81ce-1772980237065.png',
      ...
      samples: [
        {
          id: 'smp-008',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_1d5d1d558-1772832719460.png',
  ...
  'prod-005': {
    ...
    files: [
      ...
      {
        id: 'file-019',
        name: 'Cardamom-Phytosanitary-Certificate-Template.pdf',
        date: 'Mar 14, 2026',
      },
    ],
      ...
      samples: [
        {
          id: 'smp-009',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_1f7d183dd-1776871097930.png',
      ...
      samples: [
        {
          id: 'smp-011',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_190cafa6b-1777719475407.png',
      ...
      references: [
        {
          id: 'ref-008',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_1b767d6dc-1766874412455.png',
      ...
      samples: [
        {
          id: 'smp-012',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_1e6189769-1776310648307.png',
        ...
        },
        {
          id: 'smp-013',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_151eefe64-1774133015049.png',
      ...
      references: [
        {
          id: 'ref-009',
          image:
            'https://img.rocket.new/generatedImages/rocket_gen_img_1b02e9e43-1765176634845.png',
